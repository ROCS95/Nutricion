                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->masa_corporal }}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Peso:</strong>
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->peso }}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Altura:</strong>
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->altura }}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Edad:</strong>
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->edad }}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Masa Muscular:</strong>
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->masa_muscular }}" >
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Masa Osea:</strong>
                                    <input type="text"class="form-control"disabled="disabled" value="{{ $paciente->masa_osea }}" >
                                </div>
                            </div>
